...
function Collapse(props) {
  // récupération des propriétés Collapse venant du parent Collapse page About
  const [selected, setSelected] = useState()

  const toggle = () => {
    // création du toggle
    if (selected === props.id) {
      // Si la valeur de l'onglet selectionnés est égale a son id
    ...
    <div className="wrapper">
      <div className="collapse">
        <div className="item">
          ...
          <div
            className={
              selected === props.id ? 'content show' : 'content'
            } /* affichage conditionnel du contenu quand l'onglet en cours vaut l'id */
          >
            {props.aboutText}
          </div>
        </div>
